...
Kube-Combo 提供了一键安装脚本来安装 0.1 版本。

</td><td>

Kube-Combo 提供了一键安装脚本来安装 0.2 版本。
...
```bash
aoy@macdeMac-3 ~ ping 114.114.114.114 -c 3
...
```markdown
安装前请参考[准备工作](http://kubecombo.github.io/prepare)。
```
